...
describe('AgentCard', () => {
  it('renders name, namespace/slug and version', () => {
    renderWithRouter(<AgentCard agent={makeAgent() as any} />)
  ...
  it('omits skill badge and endpoint block when absent', () => {
    const agent = makeAgent({
      latest_version: { version: '0.1.0', skills: [], endpoint_url: undefined },
      description: undefined,
    })
    renderWithRouter(<AgentCard agent={agent as any} />)
