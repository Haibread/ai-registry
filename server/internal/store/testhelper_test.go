...
func resetDB(t *testing.T) {
	...
	_, err := sharedDB.Pool.Exec(context.Background(),
		`TRUNCATE agent_versions, agents, mcp_server_versions, mcp_servers, publishers, audit_log, reports, sessions, role_grants, group_members, groups, users RESTART IDENTITY CASCADE`)
	if err != nil {
